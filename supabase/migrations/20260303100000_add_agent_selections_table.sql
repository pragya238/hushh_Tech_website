-- Tinder-style agent swipe selections
-- Stores every swipe decision per user (selected / rejected)
...
-- RLS: users can only see/manage their own selections
...
-- Fast feed queries: "give me agents this user hasn't swiped yet"
...
-- Batch insert RPC — handles rapid swiping (20 swipes = 1 DB call)
